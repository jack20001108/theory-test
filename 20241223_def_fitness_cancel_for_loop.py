...
def fitness(order, leadtime, begin_inventory, bom, num_simulations=1000, demand_mean=15, demand_std=5, num_periods=5, num_products=3):
    ...
    return avg_inventory, avg_shortage, com_fill_rate, product_fill_rate_by_period, average_product_fill_rate,all_fill_rate
...
# 執行 fitness
avg_inventory, avg_shortage, com_fill_rate, product_fill_rate_by_period, average_product_fill_rate,all_fill_rate = fitness(
